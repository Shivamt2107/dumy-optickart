    ...
    <div className={Styles.tn_div_1} style={{ width: '100%' }}>
      <div className={Styles.tn_div_2} style={{ width: '100%' }}>
        <Box bg="#FFFFFF" mt="0.5%">
          ...
          <Box display="flex" p="0%" ml="20px" mr="20px" gap="20px">

            <Box w="14%" cursor="pointer" bg="">
              <Link to="/">
            ...
            <Box p="0.5%" bg="" w="40%">
              <Box border="1px" h="100%" w="100%" borderRadius="5px" borderColor="#000042" bg="#FFFFFF">
                <Text color="grey" ml="2%" mt="0.5%" textAlign="center">What are you looking for</Text>
              </Box>
            </Box>

            <Box fontSize="13px" fontFamily="sans-serif" w="35%" ml="0.9%">

              <Box pt="5%" display="flex" justifyContent="center" alignItems={"center"} gap="40px" color={'black'}>
                Track order

                <Box display="flex" gap="100px" mt="-20px" justifyContent="space-evenly" alignItems="center" >
                  <Flex >
                    {isAuth === true ?
                      ...
                      <Box display={"flex"} flexDirection="row" >
                        ...
                        <Box display={"flex"}>{name ? <Text display={"flex"}>{name}</Text> : <Box><Login />
                          <Signup /></Box>
                        }</Box>
                      </Box>
                    }
          ...
          <HStack fontWeight="bold" bg="#FBF9F7" fontFamily="sans-serif" h="65px" w="" position="relative" >
            ...
            <Box spacing="5px" w="" display="flex" alignItems="center" left="82%" gap="3%" h="100%" position="absolute">
              <Image h="55%" w="30%" borderRadius="5px" cursor="pointer" src="https://static1.lenskart.com/media/desktop/img/May22/3dtryon1.png" alt="try on 3D"></Image>
              <Image h="55%" w="30%" borderRadius="5px" cursor="pointer" src="https://static1.lenskart.com/media/desktop/img/Mar22/13-Mar/blulogo.png" alt="BLU"></Image>
              <Image h="55%" w="30%" borderRadius="5px" cursor="pointer" src="https://static.lenskart.com/media/desktop/img/Feb22/18-Feb/goldlogo.jpg" alt="GOLD"></Image>
            </Box>
          </HStack>
        </Box>
      </div>
